...
const MouseKeyboard = () => {
    ...
    //? onMouseMove= mouse'umun sayfa üzerindeki hareketlerini inceler,pageX ve pageY komutunu kullanirsaniz; bulundugunuz sayfanin sol üst kösesini 0-0 kabul eder, ona göre konum bildirir
    const mouseOlayi = (e) => {
    ...
    return (
        <div className='container text-center mt-4 d-flex flex-column align-items-center'>
            ...
            <div>
                <h2 className='text-danger mt-4'>Keyboard-Clipboard Events</h2>
